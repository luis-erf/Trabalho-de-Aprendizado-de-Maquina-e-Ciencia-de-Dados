...
def processamento(verbose = False, plot = False):
    if verbose:
        print("\n" + "="*80)
    ...
    df_2010 = pd.read_csv(DATASETS_DIR /'INMET_S_RS_A801_PORTO ALEGRE_01-01-2010_A_31-12-2010.CSV', encoding='latin1', sep=';', skiprows=8)

    df_2011 = pd.read_csv(DATASETS_DIR /'INMET_S_RS_A801_PORTO ALEGRE_01-01-2011_A_31-12-2011.CSV', encoding='latin1', sep=';', skiprows=8)

    df_2012 = pd.read_csv(DATASETS_DIR /'INMET_S_RS_A801_PORTO ALEGRE_01-01-2012_A_31-12-2012.CSV', encoding='latin1', sep=';', skiprows=8)
